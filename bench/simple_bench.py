...
env        = dict(os.environ)
exec_name  = "/gpfs/bbp.cscs.ch/home/fouriaux/Devel/adios_dev/hola_adios/bench/build/adios_raw_perfs"
  ...
  for s in sizes:
    for t in transports:
      for i in range (10)
        ...
        env["DARSHAN_LOGFILE"]  = "/gpfs/bbp.cscs.ch/home/fouriaux/Devel/adios_dev/hola_adios/bench/build_blue/variations/test1/{p}_{s}_{sample}.darshan".format(p=p, s=s, sample=i)
